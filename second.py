...
def displayField():
  ...
  """ 
  A function that sets the field that iterates through the field
  Sets the boundaries and field
...
def inputInArray(num, turn):
  ...
  Will be later utilized in the main function 
  """
  num -= 1
  if (num == 0):
    field[0][0] = turn
...
def main_function():
  ...
  if (choose == 'yes' or choose == 'yea'):
    ...
    ### Its the player turn
      if (turnCounter % 2 == 1): # Determines cpu goes first 
        displayField()
