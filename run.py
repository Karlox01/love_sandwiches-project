...
# from pprint import pprint This will not be used in Heroku .
...
def get_sales_data():
    ...
    while True:
        ...
        data_str = input('Enter your data here:\n') # For Heroku we need to add \n at the end of the string Otherwise it wont work. Need to keep this in mind when deploying to heroku.
